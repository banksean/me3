...
\section{Skills}
  ...
  \resumeSubHeadingListStart
    \small{\item{
        ...
        \textbf{Technologies:}{ gRPC, JSON/REST, Git, Bazel, Web Components, GCP, BigQuery, Docker, Kubernetes, CoLab/Jupyter Notebooks, Sqlite, DuckDB, CockroachDB, Spanner, MySQL, TensorFlow } \\ \vspace{3pt}

        \textbf{Interests:}{ Developer Productivity, Logging Instrumentation and Analysis, Distributed Tracing, ML Training Data Pipelines, ML Model Inference Serving, Data Analysis and Visualization, Experiment Design, Performance Benchmarking and Analysis, CI/CD Automation } \\ \vspace{3pt}
...
\section{Bold Software, 2024 \textbf{--} Present}
  \vspace{3pt}
  \resumeSubHeadingListStart

    \resumeSubheading
      {Sketch.dev (Bold Software)} {San Francisco, California, United States}
      {Staff Software Engineer} {September 2024 \textbf{--} Present, Full-time}
        \resumeItemListStart
        \resumeItem{Core engineer for \href{https://sketch.dev}{sketch.dev}, a hosted, containerized, chat-driven coding agent.}
        \resumeItem{Helped design and implement the initial architecture and feature set for launch}
        \resumeItem{Go, Sqlite, LLM inference APIs, sshpiper, git proxy, containers, docker, gvisor}
        \resumeItem{“Vanilla” Web UI: typescript, web components, tailwind CSS, SSE for realtime updates}
        \resumeItem{GitHub App integration for agent loop (auth, webhooks, REST API)}
        \resumeItem{Prometheus metrics, Grafana dashboards}
        \resumeItem{VSC extension (InlineCompletionProvider), LSP proxy server for early prototypes}
        \resumeItem{User event logs analysis with sqlite, duckdb, jupyter notebooks}
        \resumeItem{User community engagement, feedback, and support via Discord and GitHub Discussions}     
        \resumeItemListEnd
